app.controller(
  ...
  function (
    ...
    function GetProvince() {
      licenseService
        .getAllProvince($scope.Keyword, 0, 0)
        .then(function (items) {
    ...
    function GetDistricts(CityId) {
      licenseService
        .getDistrict(CityId, CityCode, $scope.Keyword, 0, 0)
        .then(function (items) {
    ...
    function GetCommune(DistrictId) {
      licenseService
        .getCommunes(DistrictId, CityCode, DistrictCode, $scope.Keyword, 0, 0)
        .then(function (items) {
    ...
    $scope.EDIT = function (item, asideId) {
      ...
      licenseService
        .getSingleCommune(item.Construction.CommuneId)
        .then((item) => ($scope.Loc = item));
      $scope.Id = item.Construction.TypeOfConstructionId;
      $scope.license = item;
          ...
          if (msg.data.Id > 0) {
            ...
            if ($scope.license.Construction.ConstructionItems !== undefined) {
              if ($scope.license.Construction.ConstructionItems !== null) {
                $scope.license.Construction.ConstructionItems.forEach(function (
                  conItem
                ) {
            ...
            if ($scope.license.Construction.Inspection != null) {
              ...
              $scope.license.Construction.Inspection.forEach(function (
                item,
                index
              ) {
                if (
