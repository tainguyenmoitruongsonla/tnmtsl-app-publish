    ...
    function (
        ...
        function GetCommune() {
            licenseService
                ...
                .then(function (items) {
                    ...
                    if ($scope.license && $scope.license.Construction && $scope.license.Construction.CommuneId) {
        ...
        function SyncSelectedCommuneToAdminUnit() {
            if ($scope.license && $scope.Communes) {
                var commId = $scope.license.Construction && $scope.license.Construction.CommuneId;
                if (commId) {
                    var selected = $scope.Communes.find(function (c) {
                        return c.Id === commId;
                    });
